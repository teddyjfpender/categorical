...
export function ExerciseNav({
  ...
  return (
    <div className="h-12 flex items-center justify-between px-4 border-b border-border bg-bg-secondary flex-shrink-0">
      {/* Left: sidebar toggle + breadcrumb */}
      <div className="flex items-center gap-3 min-w-0">
        <button
          onClick={onToggleSidebar}
          className="p-1.5 rounded hover:bg-bg-hover text-text-muted hover:text-text-primary transition-colors flex-shrink-0"
        ...
        <div className="flex items-center gap-2 text-sm min-w-0">
          <a href="/" className="text-text-muted hover:text-text-secondary transition-colors flex-shrink-0">
            <span className="text-accent font-semibold">C</span>
          </a>
          <span className="text-text-muted/40 flex-shrink-0">/</span>
          <span className="text-text-muted truncate flex-shrink-0">{moduleTitle}</span>
          <span className="text-text-muted/40 flex-shrink-0">/</span>
          <span className="text-text-secondary truncate">{exerciseTitle}</span>
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          className="p-1.5 rounded hover:bg-bg-hover text-text-muted hover:text-text-primary transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
        >
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.5">
            <polyline points="9,2 4,7 9,12" />
          </svg>
        </button>
        <span className="text-xs text-text-muted px-2 tabular-nums">
